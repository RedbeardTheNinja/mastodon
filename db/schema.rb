...
ActiveRecord::Schema[8.0].define(version: 2026_04_05_000002) do
  ...
  create_table "custom_feed_configs", force: :cascade do |t|
    ...
    t.string "feed_type", default: "standard", null: false
    t.index ["account_id"], name: "index_custom_feed_configs_on_account_id"
    t.index ["feed_type"], name: "index_custom_feed_configs_on_feed_type"
  ...
  create_table "custom_feed_steps", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["custom_feed_config_id", "phase", "position"], name: "index_custom_feed_steps_on_config_phase_position"
    t.index ["custom_feed_config_id", "phase", "step_type"], name: "index_custom_feed_steps_unique_type_per_phase", unique: true
  ...
  create_table "recommendation_signals", force: :cascade do |t|
    t.bigint "account_id", null: false
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["account_id", "signal_type", "entity_id"], name: "idx_rec_signals_lookup", unique: true
    t.index ["account_id"], name: "index_recommendation_signals_on_account_id"
  end
  ...
  add_foreign_key "recommendation_signals", "accounts"
