...
| Feature                                | Description                                                                                                                                                                                                                                                                                                                            |
| -------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [Custom Feeds System](custom-feeds.md) | Extensible pluggable-pipeline system for custom algorithmic feeds backed by any Mastodon List. Includes push and pull sources, multiple filter types, removal strategies, overflow strategies, and algorithmic feeds (affinity scoring with signal collection, pending queue, pluggable algorithm interface, and score-aware filters). |
| [Monitoring](monitoring.md)            | Prometheus/Grafana stack measuring custom feed performance. Documents the repo customizations that enable it (custom metrics client, StatsCollectorWorker, TypeCollector) and how to run the local stack and production exporters.                                                                                                     |
